...
Перед началом работы с ECU внимательно прочтите [Leaf ECU Manual](https://github.com/Dimonlipko/Leaf-ECU-Configurator/blob/main/Leaf_ecu_manual.pdf), и только после начните подключеть проводку, после чего установите программу конфигуратора. 

Проверяйте актульные обновления на этой странице, так как проект все еще развиваеться и появляються новые функции в старых контроллерах.
