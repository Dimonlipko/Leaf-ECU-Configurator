...
Перед началом работы с ECU внимательно прочтите Leaf_ECU_Manual [Leaf ECU Manual](../blob/main/Leaf_ecu_manual_1.7v.pdf), и только после начните подключеть проводку, после чего установите программу конфигуратора.
